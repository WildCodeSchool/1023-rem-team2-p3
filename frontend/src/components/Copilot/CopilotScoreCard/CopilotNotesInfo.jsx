  ...
  return (
    <div className="grid grid-cols-4 lg:grid-cols-6 gap-8 m-2">
      {notes.length === 0 ? (
        <>
          <div
            className={`rounded-full border-white border-2 bg-background-color-second text-white w-20 h-20 md:w-28 md:h-28 flex justify-center items-center flex-col ${user.data.poste === "gardien" && "hidden"}`}
          >
            <span className="text-[20px] font-bold">0</span>
          </div>
          <div
            className={`flex flex-col  items-center pl-3 ${user.data.poste === "gardien" && "hidden"}`}
          >
          ...
          <div
            className={`flex flex-col  items-center ${user.data.poste === "gardien" && "hidden"}`}
          >
          ...
          <div
            className={`rounded-full border-white border-2 bg-background-color-second text-white w-20 h-20 md:w-28 md:h-28 flex justify-center items-center flex-col ${user.data.poste && user.data.poste !== "gardien" && "hidden"}`}
          >
            <span className="text-[20px] font-bold">0</span>
          </div>
          <div
            className={`flex flex-col  items-center ${user.data.poste && user.data.poste !== "gardien" && "hidden"}`}
          >
          ...
          <div
            className={`rounded-full border-white border-2 bg-background-color-second text-white w-20 h-20 md:w-28 md:h-28 flex justify-center items-center flex-col `}
          >
            <span className="text-[20px] font-bold">0</span>
          </div>
