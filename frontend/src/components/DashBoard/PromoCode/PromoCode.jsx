...
export default function PromoCode() {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="mx-10 overflow-x-auto my-5">
        <div className="flex flex-col ">
          <div className="px-4 py-2 flex justify-between gap-3 pointer  bg-[#5b4f67]">
            <p className="w-32 text-center">Nom</p>
            <p className="w-32 text-center">Pourcentage</p>
            <p className="w-32 text-center">Quantité</p>
            <p className="w-32 text-center">Date de validité</p>
          ...
          {currentDiscount
            ...
            .map((discounts, index) => (
              ...
              >
                ...
                <p className="w-32 text-center">{discounts.percent_value} %</p>
                <p className="w-32 text-center">{discounts.quantity}</p>
